...
6. Copy **OAuth Redirect URL** from VocbotAI to **Redirect URL(s)** field.
7. Copy **Client ID** to **Client ID** field on VocbotAI.
8. Copy **Client Secret** to **Client Secret** field on VocbotAI.
