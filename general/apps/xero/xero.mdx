...
5. Copy **OAuth Redirect URL** from VocbotAI to **Redirect URL** field.
...
10. Copy the **Client secret 1** value to the `Client Secret` field on VocbotAI.
11. Start using Xero integration with VocbotAI!
