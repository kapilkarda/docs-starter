...
6. Copy **OAuth Redirect URL** from VocbotAI and paste it in **Allowed origins** and click on the **Add** button.
7. Copy the **API key** value to the **API key** field on VocbotAI.
