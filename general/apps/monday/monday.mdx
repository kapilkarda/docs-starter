...
4. Click on the **Show** button and copy the access token from the page to the `API Token` field on VocbotAI.
5. Now, you can start using the Monday connection with VocbotAI.
