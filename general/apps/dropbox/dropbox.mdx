...
1. Copy **OAuth Redirect URL** from VocbotAI to **Redirect URIs** field and add it.
...
1. Copy **App key** to **App key** field on VocbotAI.
1. Copy **App secret** to **App secret** field on VocbotAI.
