...
10. Copy **OAuth Redirect URL** from VocbotAI and paste it to the **Callback URL** field.
11. Click **Save changes**.
12. Paste **Key** and **Secret** values you have saved from the 8th step and paste them into VocbotAI as **Consumer Key** and **Consumer Secret**, respectively.
13. Click **Submit** button on VocbotAI.
14. Now, you can start using the Flickr connection with VocbotAI.
