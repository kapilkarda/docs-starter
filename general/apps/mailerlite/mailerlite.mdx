...
6. Copy the token from the popup to the `API Key` field on VocbotAI.
7. Write any screen name to be displayed in VocbotAI.
8. Now, you can start using the MailerLite connection with VocbotAI.
