...
description: "Step-by-step guide to create a Zeplo account, connect WhatsApp, and generate API credentials for VocbotAI integration."
---

## Step-by-Step Zeplo Setup

This guide walks you through creating a Zeplo account, connecting your WhatsApp Business channel, and generating the API credentials needed for VocbotAI integration.
...
4. Save this value — you'll need it for the VocbotAI configuration.
...
3. Enter a name for the key (e.g., "Vocbot AI Integration").
...
### Step 7: Configure Zeplo in VocbotAI

Now that you have your credentials from Zeplo, configure them in VocbotAI:

1. Log in to the **VocbotAI dashboard**.
2. Click the **VocbotAI logo** in the top left corner to open the menu.
...
After saving your Zeplo credentials in VocbotAI:
