...
## Here are the steps to connect your VocbotAI account with Salesforce.
...
6. Complete the steps to connect your VocbotAI account with Salesforce.

Once you have completed these steps, your VocbotAI account will be integrated with Salesforce allowing you to sync data.
