---
title: LMNT
description: "Bring your LMNT voice capabilities to VocbotAI for lifelike conversations."
---
...
<ul>
    ...
    <li>Now, head over to your VocbotAI dashboard, go to the Integrations section, and select LMNT.</li>

    <li>Paste the copied API key into the provided field and click Save to successfully link LMNT with VocbotAI.</li>

</ul>

## Configure LMNT Voice Settings in VocbotAI

<ul>

    <li>Navigate to Assistant Settings within your VocbotAI account.</li>
