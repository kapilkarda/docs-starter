...
## To integrate Vocbot AI with GoHighlevel, follow these steps:

1. Navigate to the integration option within Vocbot AI and select GoHighlevel.
...
5. Choose the account you wish to connect with your Vocbot AI account to confirm a successful connection to GoHighlevel.
