...
1. Navigate to the integration option within Precall AI and select GoHighlevel.
...
5. Choose the account you wish to connect with your Precall AI account to confirm a successful connection to GoHighlevel.
