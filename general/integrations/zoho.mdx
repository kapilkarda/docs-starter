...
## To integrate VocbotAI with Zoho, follow these steps:

1. Go to the integrations section of VocbotAI and click on Zoho.

2. Enter your email address or phone number to sign in, then click on "Next."

3. Enter your password and click on the "Access" button to allow VocbotAI to access data in your Zoho account.
