---
title: Neuphonic
description: "Bring your Neuphonic voice capabilities to VocbotAI for lifelike conversations."
---
...
<ul>
    ...
    <li>Go to the Integrations tab within your VocbotAI account.</li>
...
<ul>
    ...
    <li>Navigate to Assistant Settings in your VocbotAI dashboard.</li>
    ...
    <li>If you’ve created custom voices on Neuphonic, you can link and use them directly within VocbotAI.</li>
...
Now your VocbotAI assistant will engage users with lifelike, emotionally rich voices, powered by Neuphonic's advanced AI speech synthesis.
