...
Now enter the identifier name, email, or anything that you want. I have a name, Allison, as the identifier. Add the question "Have you heard about VocbotAI before?". The question is now saved, and you can edit or delete it if needed. Add questions and options in the Single Choice and Open Question options, as per your preference then click Create.

Here is the information in the correct format:

### Here are the steps to sync data between VocbotAI and your CRM (HubSpot, Salesforce and Zapier Hook):

1. After making an outbound or inbound call in VocbotAI, the call data will be automatically updated in your connected CRM platform(s).

2. To manage the CRM sync Action, go to the VocbotAI dashboard click on the assistant field and update your assistant setting by clicking on the new assistant button.
...
Then, All call data from your outbound or inbound calls in VocbotAI will be automatically synced to your connected HubSpot, Salesforce or Zapier Hook CRM.

### Zapier Hook.

VocbotAI lets you set up actions like booking appointments and sending links through Zapier. Too many actions can confuse the AI, so keep the number of actions small for the best results.

To integrate Vocbot AI with Zapier Hook, follow these steps: 
...
By following these steps, you can integrate VocbotAI with Zapier and set up automated actions through the Zapier platform.
