...
The process of adding contacts to a [contact list](https://vocbot.netlify.app/admin/segments) is as quite simple. <br/> We can bulk upload contacts to a segment list via a .csv file or we can add the contacts manually.
