...
<Steps>
  <Step title="Create Elastic SIP Trunking">
    ...
    <ul>
        <li>
            ...
            <ul>
                <li>
                    If you opt for the auth route, you need to specify the username and password in the next step when importing the number to VocbotAI.
                </li>
            </ul>
            <Frame>
            ...
            <ul>
                <li>
                    Currently VocbotAI SIP server does not have a static IP, so if you opt for the IP route, you need to whitelist all the IP addresses in the range like following:
                </li>
            </ul>
    ...
    <ul>
        <li>
            Here you will specify VocbotAI’s SIP server address as the origination SIP URI:
  ...
  <Step title="Import numbers to VocbotAI">
    Now the number is set up with your elastic SIP trunking, you need to import the number to VocbotAI so that we will know how to route the call.
