...
<Steps>
  <Step title="Create Elastic SIP Trunking">
    ...
    2. Add FQDN Add the FQDN of VocbotAI’s SIP server:
    ...
    Select credentials as the authentication method, and add the username and password. You will need to use this username and password when importing the number to VocbotAI.
