...
## Here are the steps to connect your VocbotAI account with Hubspot and Salesforce.
...
6. Complete the steps to connect your VocbotAI account with HubSpot and Salesforce.

Once you have completed these steps, your VocbotAI account will be integrated with HubSpot and Salesforce allowing you to sync data between the two platforms.

## Here are the steps to sync data between VocbotAI and your CRM (HubSpot and Salesforce):
...
Then, All call data from your outbound or inbound calls in VocbotAI will be automatically synced to your connected HubSpot or Salesforce CRM.
